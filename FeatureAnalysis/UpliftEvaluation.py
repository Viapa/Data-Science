...
# 计算uplift最佳的差值系数
def CalBestCoef(table_name, alpha_range=(0.1, 0.9), step=0.1):
    """
    ...
    for alpha in np.arange(alpha_range[0], alpha_range[1], step):
        ...
        Evaluator = BinaryClassificationEvaluator(labelCol="label", rawPredictionCol="uplift_score", metricName='areaUnderROC')
